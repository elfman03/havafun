...
release: 
	zip havafun-win.zip *.exe *.cmd RELEASE_NOTES.html
	tar -czvf havafun-lin.tar.gz hava_channel hava_record *.sh RELEASE_NOTES.html

windows: hava_channel.exe hava_channel_nowin.exe hava_record.exe
