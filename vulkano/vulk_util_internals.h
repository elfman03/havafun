 ...
 * Internal bits needed to implement the protocol to talk to Vulkano
 *
 ...
 *
 */
#ifndef VULK_UTIL_INT_H_
#define VULK_UTIL_INT_H_ 1
...
#define CHANNEL_INPUT_OFFSET 31

// Basic form of a remote control button push
const unsigned char button_push[56]={ 0x03,0x07,0xfa,0xce,0x00,0x00,0x00,0x14,
                                      0x00,0x00,0x00,0x0b,0x00,0x00,0x00,0xf2,
                                      0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x20,
                                      0x08,0x08,0x00,0x01,0x00,0x01,0x00,0x00,
                                      0x00,0x00,0x00,0x0f,0x00,0x10,0x00,0x00,
                                      0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,
                                      0x07,0x01,0xff,0xff,0xff,0x80,0x00,0x00 };

#define BUTTON_REMOTE_OFFSET_HI 50
#define BUTTON_REMOTE_OFFSET_LO 51
#define BUTTON_OFFSET    52

// Basic form of a LEARNED remote control button push
// Thanks to blackrat(Dieder) at hava forums
//
const unsigned char 
      button_push_learned[42]={ 0x03,0x07,0xfa,0xce,0x00,0x00,0x00,0x14,
...
const char *Vulk_inputs[4]={ "Coax","Composite","Svideo","Component" };

// 
// C:\Program Files\Monsoon Multimedia\Vulkano\PC Player\PKv23.key
//
// A scattering of these codes seemed to match from hava so I transcribed
// the full set.   Mileage may vary
//
const char *Vulk_buttons[256]={
0,	// 0(0x00)
"Power",	// 1(0x01)
"PowerOn",	// 2(0x02)
"PowerOff",	// 3(0x03)
...
"Info",	// 46(0x2e)
"AspectRatio",	// 47(0x2f)
"DayUp_or_SAP",	// 48(0x30)
"DayDown_or_Lang",	// 49(0x31)
"Slow",	// 50(0x32)
"Eject",	// 51(0x33)
"Custom52",	// 52(0x34)
"PIPOn",	// 53(0x35)
...
// Thanks to blackrat(Dieder) at hava forums
// 
const char *Vulk_buttons_learned[256]={
  0, // 0(0x00)
  0, // 1(0x01)
  0, // 2(0x02)
  0, // 3(0x03)
